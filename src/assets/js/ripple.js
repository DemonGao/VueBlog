(function(){
  ...
  var opacity = 0.3;
  var ripple_within_elements = ['button', 'a','section'];
      ...
      return function(){
        ...
        switch($element.transition_phase){
          case 1:
            ...
            // console.log($element.ripple_backgroundSize);
            ...
            setTimeout($element.next_transition, 1 * 1000); //now I know transitionend is better but it fires multiple times when multiple properties are animated, so this is simpler code and (imo) worth tiny delays
            break;
          case 2:
  ...
  var click = function(event){
    ...
    //匹配ripple_within_elements中的元素,若存在则获取当前容器的大小
    if(ripple_within_elements.indexOf(touch.target.nodeName.toLowerCase()) > -1) {
      ...
      //如果点击的是其他元素,则 设置默认的水波纹大小  即ripple_without_diameter
